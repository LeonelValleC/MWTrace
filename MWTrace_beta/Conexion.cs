...
namespace MWTrace_beta
{
    internal class Conexion
    {
        ...
        public Conexion() =>
        Con1 = new SqlConnection(@"Data Source=MEX-SQL-001;Initial Catalog=MWTrace-TEST;User ID=admin_sql;Password=DaBatase#40107;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        ...
        /// <summary>
        /// Metodo Para saber si ya existe un registro y regresar el ID
        /// </summary>
        /// <param name="comando"></param>
        /// <returns></returns>
        public int ExisteID(string comando)
        {            
            Cerrar();
            using (SqlCommand cmd = new SqlCommand(comando, Con1))
            {
