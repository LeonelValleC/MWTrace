...
namespace MWTrace_Part2
{
    internal class Conexion
    {
        ...
        //Con1 = new SqlConnection(@"Data Source=192.168.1.4\SQLEXPRESS;Initial Catalog=MWTraceTest;User ID=admin;Password=mbettaglo;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        ...
        {
            Abrir();
            using (var CMD = new SqlDataAdapter(Comando,Con1)) // Creamos un DataAdapter con el Comando y la Conexion
            {
        ...
        /// <param name="comando"></param>
        /// <returns></returns>
        public string ReturnValueNull(string comando)
        {
            string valor;
            try
            {
        ...
        public DataView Leer_Datos(string query, string tabla)
        {
            ...
            return ((DataTable)res.Tables["tb_ModeloOrden.id_modeloOrden, tb_ModeloOrden.scanmodem, tb_ModeloOrden.scansim , tb_ModeloOrden.fecharegistro, tb_ModeloOrden.id_orden , tb_Orden.orden, tb_pallette.pellette, tb_pallette.id_pellette"]).DefaultView;
        }
